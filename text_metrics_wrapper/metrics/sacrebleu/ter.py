...
def Ter_sacrebleu(
    ...
    **kwargs,
    ...
    Returns:
        A dictionary containing the TER score.
    ...
    result = ter.corpus_score(hypothesis, references_post)

    logger.info("Computing TER score... FINISHED!")

    return {"ter": result.score}
